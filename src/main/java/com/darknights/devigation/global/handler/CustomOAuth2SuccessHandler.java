package com.darknights.devigation.global.handler;


import com.darknights.devigation.global.exception.BadRequestException;
import com.darknights.devigation.global.configuration.AppProperties;
import com.darknights.devigation.global.security.command.application.service.IssueTokenService;
import com.darknights.devigation.global.security.command.domain.aggregate.util.CookieUtils;
...
import static com.darknights.devigation.global.security.command.domain.repository.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
